  ...
  return (
    <section className="flex flex-col items-center justify-center gap-4 py-8 md:py-16">
      <div className="text-center text-balance max-w-prose">
        ...
        >
          Transforms exam prep for&nbsp;
          <span className={text({ size: "sm", wide: true, color: "violet" })}>
            REET, NEET, and State PSCs
          </span>
          &nbsp;with daily test targets, smart revision, and gamified routines.
        </div>
      </div>
      <Link
